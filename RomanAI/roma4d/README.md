...
- **Roma4D** is released under the **Apache License, Version 2.0** — see **[LICENSE](LICENSE)** (Copyright 2026 Daniel Harding - RomanAILabs unless otherwise noted).
- The **Roma4D** name, logos, and related branding are **trademarks** of their respective owners; the Apache 2.0 license grants rights to the **software**, not to use those marks as your product name without permission. When in doubt, ask the maintainers.
